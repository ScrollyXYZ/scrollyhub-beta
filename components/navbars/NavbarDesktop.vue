<template>
  <nav class="navbar navbar-expand-lg navbar-bg-custom">
    <div class="container-fluid">
      ...
      <NuxtLink class="navbar-brand" to="/nft">
        <img src="/img/favicon.png" alt="Chat logo" height="35" />
        <span class="navbar-brand-text ms-2 align-middle">NFT</span>
      </NuxtLink>
      <NuxtLink class="navbar-brand" to="http://sns.scrolly.xyz">
        <img src="/img/favicon.png" alt="Chat logo" height="35" />
        <span class="navbar-brand-text ms-2 align-middle">SNS</span>
      </NuxtLink>
      <NuxtLink class="navbar-brand" to="/partnership">
        <img src="/img/favicon.png" alt="Chat logo" height="35" />
        <span class="navbar-brand-text ms-2 align-middle">Partnership</span>
      </NuxtLink>
      <ul class="navbar-nav justify-content-end flex-grow-1">
        ...
        <li
          v-if="isActivated && $config.chatTokenAddress"
